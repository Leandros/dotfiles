...
local spec = {
...

  {
    ...
    config = function()
      ...
      function _G.ibl_setup()
        ...
        ---@type ibl.config
        require("ibl").setup({
          -- clashes with rainbow-delimiters
          -- see: <https://github.com/lukas-reineke/indent-blankline.nvim/issues/555>
          -- and: <https://github.com/HiPhish/rainbow-delimiters.nvim/issues/2#issuecomment-2461235126>
...

  {
    ...
    keys = {
      "ge", -- Default invocation prefix
      { "ge.", "<cmd>TextCaseOpenTelescope<CR>", mode = { "n", "x", "v" }, desc = "Telescope" },
    },
    cmd = {
