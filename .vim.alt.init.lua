...
---@return table
local function decode_settings_json(json_content)
  local json5 = require('json5')
  local ok, json_tbl = pcall(json5.parse, json_content)
...
while True:
  ...
  {
    -- "mrcjkb/rustaceanvim",
    dir = '/local/home/gerstarv/github/rustaceanvim',
        ...
        return {
          ...
          server = {
            ...
            root_dir = function(filename, default)
              ...
              print('rootdir: '..filename .. ' | num: ' .. vim.inspect(#clients))
              -- if #clients == 0 then
